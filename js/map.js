        ...
        $.getJSON("js/insta_geo_new.json", function(json) {
            ...
            for (var i = 0; i < found_obj.length; i++) {
                ...
                new_json.push({
                    ...
                    "geometry": {
                        "type": "Point",
                        "coordinates": [found_obj[i]['latitude'],found_obj[i]['longitude']]
                    },
                    "properties": {
                        "balloonContent": found_obj[i]['place'],
                        "clusterCaption": "Метка с iconContent",
                        "hintContent": "Рейтинг места, " + found_obj[i]['rating'],
                        "iconContent": found_obj[i]['rating']
                    },
                    "options": {
                        "iconColor": color,
